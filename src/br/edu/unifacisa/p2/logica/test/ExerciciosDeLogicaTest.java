...
class ExerciciosDeLogicaTest {
  ...
  void testValidaCPF() {
     ...
     */
    assertTrue(ExerciciosDeLogica.validaCPF("443.344.420-05"));
    assertTrue(ExerciciosDeLogica.validaCPF("776.863.620-19"));
    assertTrue(ExerciciosDeLogica.validaCPF("847.153.580-77"));
    // CPFs inválidos
    ...
    assertFalse(ExerciciosDeLogica.validaCPF("333.333.333-33"));
  }
